...
export default function Navbar() {
  ...
  const getRoleLabel = () => {
    switch (role) {
      ...
      case 'SERVICE_STAFF': return 'Service Staff';
      case 'SERVICE_LEAD': return 'Service Lead';
              ...
              <>
                ...
                <li className="nav-item">
                  <NavLink className="nav-link" to="/faculty/requests">
                    <i className="bi bi-journal-text me-1"></i> My Requests
                  </NavLink>
                </li>
              </>
            )}
              ...
              <>
                ...
                <li className="nav-item">
                  <NavLink className="nav-link" to="/stafflead/requests">
                    <i className="bi bi-clipboard-check me-1"></i> Manage Requests
                  </NavLink>
                </li>
              </>
            )}
            ...
            {user ? (
              <>
                <div className="text-white d-flex align-items-center gap-2">
                  <span className="badge bg-light text-dark fw-bold px-2 py-1">
                    {getRoleLabel()}
                  </span>
