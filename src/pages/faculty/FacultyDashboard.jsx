      ...
      <div className="portal-card p-4 mb-4 bg-white d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3">
        <div>
          <h2 className="fw-bold mb-1">
            ...
            Faculty Portal — <span className="text-primary">{user?.name || 'Faculty'}</span>
          </h2>
          <p className="text-muted mb-0">
            Submit and track service requests for academic resources, lab facilities, and administrative needs
          </p>
        </div>
        <div>
          <Link
          ...
          {loading ? (
            ...
            <div className="text-center py-5">
              ...
              <p className="text-muted small mb-3">
                Need lab equipment, facility access, or administrative support? Submit a request to get started.
              </p>
