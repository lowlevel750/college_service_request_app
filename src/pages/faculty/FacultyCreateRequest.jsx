...
export default function FacultyCreateRequest() {
  ...
  const loadCategories = async () => {
    try {
      ...
      // Fallback gracefully to default categories
      setCategories(defaultCategories);
      setCategory(defaultCategories[0]);
    }
  };
          ...
          <div className="portal-card p-4 p-md-5">
            <div className="mb-4">
              ...
              <p className="text-muted small">
                Submit a request for academic resources, lab facilities, administrative support, or other services
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-3">
                ...
                <input
                  type="text"
                  className="form-control"
                  placeholder="e.g. Lab Projector Replacement for Room 301"
                  value={title}
              ...
              <div className="d-flex justify-content-end gap-2">
                <Link to="/faculty/requests" className="btn btn-outline-secondary px-4">
                  Cancel
                </Link>
                <button
                  type="submit"
